...
def add_slide_header(slide, title_text, category="VULNERABILITY TECHNICAL BRIEFING"):
    ...
    cat_box = slide.shapes.add_textbox(
        Inches(0.8), Inches(0.4), Inches(11.7), Inches(0.3)
    )
    tf_cat = cat_box.text_frame
    tf_cat.word_wrap = True
    tf_cat.margin_left = tf_cat.margin_right = tf_cat.margin_top = (
        tf_cat.margin_bottom
    ) = 0
    ...
    title_box = slide.shapes.add_textbox(
        Inches(0.8), Inches(0.6), Inches(11.7), Inches(0.8)
    )
    tf_title = title_box.text_frame
    tf_title.word_wrap = True
    tf_title.margin_left = tf_title.margin_right = tf_title.margin_top = (
        tf_title.margin_bottom
    ) = 0
...
def add_info_card(
    slide, left, top, width, height, title, subtitle, content, border_color
):
    card = slide.shapes.add_shape(
        pptx.enum.shapes.MSO_SHAPE.RECTANGLE, left, top, width, height
    )
...
# Title Text Box
title_box = slide.shapes.add_textbox(
    Inches(0.8), Inches(2.2), Inches(11.7), Inches(3.0)
)
...
p3 = tf.add_paragraph()
p3.text = (
    "A Complete End-to-End Demonstration and Privilege Escalation Walkthrough on Docker"
)
...
p_meta.text = (
    "TECHNICAL ASSESSMENT & LAB HANDS-ON DEMONSTRATION  |  SYSTEM SECURITY SERIES"
)
...
set_dark_bg(slide)
add_slide_header(
    slide, "Executive Summary: CVE-2016-5195", "VULNERABILITY TECHNICAL BRIEFING"
)
...
add_info_card(
    ...
    Inches(5.3),
    Inches(4.8),
    "Threat Landscape Facts",
    "Vulnerability Timeline & Intel",
    [
...
set_dark_bg(slide)
add_slide_header(
    slide, "Dirty COW inside Docker Containers", "CONTAINER SECURITY INSIGHTS"
)
...
set_dark_bg(slide)
add_slide_header(
    slide, "Privilege Escalation to Container Escape", "THREAT PATHWAY ANALYSIS"
)
...
set_dark_bg(slide)
add_slide_header(
    slide, "Hands-on Lab: Container Environment", "DOCKER LAB INFRASTRUCTURE"
)
...
set_dark_bg(slide)
add_slide_header(
    slide, "Executing the Lab & Outcome Analysis", "PRACTICAL LAB SHOWCASE"
)
...
set_dark_bg(slide)
add_slide_header(
    slide, "Real-world Exploitation & Notable Cases", "SECURITY IMPACT ANALYSIS"
)
